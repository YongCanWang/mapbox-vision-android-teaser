...
class ArMapActivity : AppCompatActivity(), MapboxMap.OnMapClickListener, OnMapReadyCallback,
    ...
    override fun onStart() {
        super.onStart()
//        route = loadGeoJsonFromAsset(this, "route1.geojson")
        mapView.onStart()
    ...
    override fun onMapLongClick(point: LatLng): Boolean {
        isLocation = false
        originMarker?.let(mapboxMap::removeMarker)
        originMarker = mapboxMap.addMarker(MarkerOptions().position(point))
        originPoint = Point.fromLngLat(
            point.longitude,
            point.latitude
        )
        ...
        mapboxNavigation?.requestRoutes(
            ...
            routesRequestCallback = object : RoutesRequestCallback {
                ...
                override fun onRoutesRequestCanceled(routeOptions: RouteOptions) {
                    Toast.makeText(this@ArMapActivity, "Route request canceled!", Toast.LENGTH_LONG)
                        .show()
                }
                ...
                override fun onRoutesRequestFailure(
                    ...
                    Toast.makeText(this@ArMapActivity, "Route request failure!", Toast.LENGTH_LONG)
                        .show()
                }
            }
        )
    ...
    fun onRoute1(view: View) {
        addRoute("route1.geojson")
    }

    fun onRoute2(view: View) {
        addRoute("route2.geojson")
    }

    fun onRoute3(view: View) {
        addRoute("route3.geojson")
    }


    private fun addRoute(route: String) {
        destinationMarker?.let(mapboxMap::removeMarker)
        currentRoute = DirectionsRoute.fromJson(loadGeoJsonFromAsset(this, route))
        addRoute()
        start_ar.visibility = View.VISIBLE
    }
